"""
IranFree Tunnel - Panel (Central Controller)
"""
import os
import asyncio
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        if not cert_path.exists() or cert_path.stat().st_size == 0:
            ...
            await h2_server._generate_certs(common_name="IranFree Tunnel CA")
    ...
    try:
        ...
        if not server_cert_path.exists() or server_cert_path.stat().st_size == 0:
            ...
            await h2_server._generate_certs(common_name="IranFree Tunnel Server CA")
    ...
    try:
        ...
        async with AsyncSessionLocal() as db:
            ...
            for tunnel in tunnels:
                ...
                needs_gost_forwarding = tunnel.type in ["tcp", "udp", "ws", "grpc", "tcpmux", "quic", "relaytls"] and tunnel.core == "gost" and not tunnel.node_id
...
async def root():
    ...
    if index_path.exists():
        from fastapi.responses import FileResponse
        return FileResponse(index_path)
    return {"message": "IranFree Tunnel Panel API", "docs": "/docs"}
