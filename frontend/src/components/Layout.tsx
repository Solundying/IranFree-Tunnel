...
import IranFreeLogoDark from '../assets/SmiteD.png'
import IranFreeLogoLight from '../assets/SmiteL.png'
      ...
      <div className="flex h-screen">
          ...
          <div className="p-6 border-b border-gray-200 dark:border-gray-700">
            ...
            <div className="flex flex-col items-center gap-4">
              <div className="relative">
                ...
                <img 
                  src={darkMode ? IranFreeLogoDark : IranFreeLogoLight} 
                  alt="IranFree Tunnel Logo" 
                  className="relative h-24 w-24"
                />
              </div>
              <div className="text-center">
                <h1 className="text-xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400 bg-clip-text text-transparent">IranFree Tunnel</h1>
          ...
          <div className="p-4 border-t border-gray-200 dark:border-gray-700 space-y-2">
            ...
            <div className="flex flex-col items-center gap-2 text-xs text-gray-500 dark:text-gray-400 pt-2 border-t border-gray-200 dark:border-gray-700">
              <div className="flex flex-col items-center gap-1 text-center">
                <span>IranFree Tunnel</span>
                <div className="flex flex-wrap items-center justify-center gap-x-2 gap-y-0.5">
                  <span className="text-gray-500 dark:text-gray-400">Support & Updates:</span>
                  <a href="https://t.me/bep20vpnbot" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">@bep20vpnbot</a>
                  <span>|</span>
                  <a href="https://t.me/+OHTf8xzLwTplYzAx" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">Channel</a>
                  <span>|</span>
                  <a href="https://github.com/Solundying" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">GitHub</a>
                </div>
                <div className="flex flex-wrap items-center justify-center gap-x-2 gap-y-0.5">
                  <span>Donate (USDT-BEP20): 0x170BB3786a5af57647260d3C4EfEa8845d025010</span>
                  <span>|</span>
                  <a href="https://buymeacoffee.com/amirhossein1892" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">BuyMeACoffee</a>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <span>{version}</span>
                <a 
                  href="https://github.com/Solundying" 
                  target="_blank" 
        ...
        <main className="flex-1 overflow-auto bg-gray-50 dark:bg-gray-900" dir="ltr">
          ...
          <div className="lg:hidden sticky top-0 z-30 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-3 flex items-center justify-between shadow-sm">
            ...
            <h1 className="text-lg font-bold bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400 bg-clip-text text-transparent">IranFree Tunnel</h1>
            <div className="w-10" />
          </div>
